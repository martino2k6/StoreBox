 ...
 * an adapter implementation for storing {@link T} as an {@link Integer}.
 *
 * @param <T> type which needs to be adapted
 */
public abstract class BaseIntegerTypeAdapter<T> implements
        StoreBoxTypeAdapter<T, Integer> {
    
    protected int DEFAULT;
    
    @Override
    public final StoreType getStoreType() {
        return StoreType.INTEGER;
    }
